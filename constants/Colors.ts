const Colors = {
  ...
  text: 'hsl(221.2 5% 90%)', // Using foreground color for text
  border: 'hsl(221.2 30% 26%)',
  notification: 'hsl(0 100% 30%)', // Using destructive color for notification  
  secondary: 'hsl(221.2 30% 53.3%)', // Changed from 'secondry' to 'secondary'
  'secondary-foreground': 'hsl(0 0% 100%)', // Changed from 'secondry-foreground'
  accent: 'hsl(41.2 80% 60%)',
  'accent-foreground': 'hsl(221.2 5% 90%)',
  danger: 'hsl(0 100% 30%)', // Using destructive color for danger
